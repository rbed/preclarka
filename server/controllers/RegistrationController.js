...
class RegistrationController {
    ...
    static async * __registrationContract_Generator(forms){
        console.log('step1')
        try{
    ...
    static async registrationContract(req, res, err) {
        ...
        try{
            ...
            // const registration =  __registrationContract_Generator(forms)
            const registration =  RegistrationController.__registrationContract_Generator(forms)
...
// static async function* __registrationContract_Generator(forms){
//     console.log('step1')
//     try{
//         var user = await RegistrationController.__registerUser(forms.user)
//     }catch(e){
